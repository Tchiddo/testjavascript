...
class Laptop(Product):
    ...
    def calculate_discount_price(self, discount):
        ...
        return base_price * (
            1 - (discount / 100)
        )  # Actually applying the discount part. Made up the numbers
...
touchscreen = input("\nAlright lastly, Is it touchscreen? ").strip()
...
print(f"Discounted Price (15% off): ${user_laptop.calculate_discount_price(15):.2f}")
